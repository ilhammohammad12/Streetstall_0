...
function HomeScreen({navigation}){ 
  return(
   <View style= {styles.container}>
     ...
     <Image source ={require('./assests/Directions.png')} style={styles.direction} />
     <Text  style ={styles.item2} >Navigate to the Nearest Food stall </Text>
     </View>
...
function Login({navigation}){
  return(
    <View style= {styles.container} >
    <ImageBackground source = {require('./assests/Navigation.png')} style={styles.direction}>
    <Text style= {styles.headline}>LOGIN DETAILS</Text>
    <View style= {styles.buttonStyles} >
   <Button title="Next" color="black"
...
function App({}){
 ...
 <NavigationContainer>
  <Stack.Navigator >
  <Stack.Screen options={{headerShown: false}}  name="SplashScreen" component={firstScreen} />
